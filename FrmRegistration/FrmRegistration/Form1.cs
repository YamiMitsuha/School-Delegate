namespace FrmRegistration
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            StudentInfoClass.StudentNo = Convert.ToInt32(txt_studentNo.Text);
            StudentInfoClass.ContactNo = Convert.ToInt32(txt_contactNo.Text);
            StudentInfoClass.Age = Convert.ToInt32(txt_age.Text);
